...
// PI Invoice routes
router.post('/create/pi-invoice', createPiInvoice);
router.get('/get-all/pi-invoices', filterByRole, getPiInvoices);
router.get('/get-pi-invoice/:id', getPiInvoiceById);
...
router.put('/update/pi-invoice/:id', updatePiInvoice);
router.delete('/delete/pi-invoice/:id', deletePiInvoice);
router.put('/:id/update-pi-status', updatePiStatus);
